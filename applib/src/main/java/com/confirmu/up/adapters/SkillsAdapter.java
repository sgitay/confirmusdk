...
public class SkillsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SkillsAdapter(ChatActivity context, List<String> arrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_skills_unselected, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        itemViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.selectSkill(arrayList.get(position));
            }
        });
